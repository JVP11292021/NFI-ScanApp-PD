...
void OptionManager::AddLogOptions() {
  ...
  Register("log_to_stderr", &FLAGS_logtostderr);
  Register("log_level", &FLAGS_v);
}
...
void OptionManager::AddSequentialMatchingOptions() {
  ...
  Register("SequentialMatching.overlap",
                              &sequential_matching->overlap);
  Register("SequentialMatching.quadratic_overlap",
                              &sequential_matching->quadratic_overlap);
  Register("SequentialMatching.expand_rig_images",
                              &sequential_matching->expand_rig_images);
  Register("SequentialMatching.loop_detection",
                              &sequential_matching->loop_detection);
  Register("SequentialMatching.loop_detection_period",
                              &sequential_matching->loop_detection_period);
  Register("SequentialMatching.loop_detection_num_images",
  ...
  Register("SequentialMatching.loop_detection_num_checks",
  ...
  Register("SequentialMatching.vocab_tree_path",
                              &sequential_matching->vocab_tree_path);
  Register("SequentialMatching.num_threads",
...
void OptionManager::AddVocabTreeMatchingOptions() {
  ...
  Register("VocabTreeMatching.num_images",
                              &vocab_tree_matching->num_images);
  Register("VocabTreeMatching.num_nearest_neighbors",
                              &vocab_tree_matching->num_nearest_neighbors);
  Register("VocabTreeMatching.num_checks",
  ...
  Register("VocabTreeMatching.max_num_features",
                              &vocab_tree_matching->max_num_features);
  Register("VocabTreeMatching.vocab_tree_path",
                              &vocab_tree_matching->vocab_tree_path);
  Register("VocabTreeMatching.match_list_path",
                              &vocab_tree_matching->match_list_path);
  Register("VocabTreeMatching.num_threads",
...
void OptionManager::AddBundleAdjustmentOptions() {
  ...
  Register("BundleAdjustment.refine_focal_length",
                              &bundle_adjustment->refine_focal_length);
  Register("BundleAdjustment.refine_principal_point",
                              &bundle_adjustment->refine_principal_point);
  Register("BundleAdjustment.refine_extra_params",
                              &bundle_adjustment->refine_extra_params);
  Register("BundleAdjustment.refine_rig_from_world",
                              &bundle_adjustment->refine_rig_from_world);
  Register("BundleAdjustment.refine_sensor_from_rig",
                              &bundle_adjustment->refine_sensor_from_rig);
  Register("BundleAdjustment.use_gpu",
                              &bundle_adjustment->use_gpu);
  Register("BundleAdjustment.gpu_index",
                              &bundle_adjustment->gpu_index);
  Register("BundleAdjustment.min_num_images_gpu_solver",
