...
//
//    if (!image_list_path.empty()) {
//        reconstruction_options.image_names = colmap::ReadTextFileLines(image_list_path);
//    }
//
//    colmap::StringToUpper(&data_type);
//    reconstruction_options.data_type =
//        colmap::AutomaticReconstructionController::DataTypeFromString(data_type);
//
//    colmap::StringToUpper(&quality);
//    reconstruction_options.quality =
//        colmap::AutomaticReconstructionController::QualityFromString(quality);
//
//    colmap::StringToUpper(&mesher);
//    reconstruction_options.mesher =
//        colmap::AutomaticReconstructionController::MesherFromString(mesher);
//
//    auto reconstruction_manager = std::make_shared<colmap::ReconstructionManager>();
//
...
//            reconstruction_manager);
//        colmap::RunThreadWithOpenGLContext(&controller);
//    }
//    else {
//        colmap::AutomaticReconstructionController controller(reconstruction_options,
//            reconstruction_manager);
...
//    colmap::HierarchicalPipeline::Options mapper_options;
//    std::string output_path;
//
//    colmap::OptionManager options;
...
//    auto reconstruction_manager = std::make_shared<colmap::ReconstructionManager>();
//    colmap::HierarchicalPipeline hierarchical_mapper(mapper_options,
//        reconstruction_manager);
...
//    options.Write(colmap::JoinPaths(output_path, "project.ini"));
//
//    return EXIT_SUCCESS;
//}
//
...
//    reconstruction.Read(input_path);
//
//    size_t num_filtered = colmap::ObservationManager(reconstruction)
...
//    }
//
//    colmap::PrintHeading1("Loading model");
//
//    auto reconstruction = std::make_shared<colmap::Reconstruction>();
//    reconstruction->Read(input_path);
//
...
//    }
//
//    auto options_tmp = std::make_shared<colmap::IncrementalPipelineOptions>(options);
...
//
//    auto reconstruction_manager = std::make_shared<colmap::ReconstructionManager>();
//    colmap::IncrementalPipeline mapper(
...
//    }
//
//    colmap::Database database(colmap::Database::kInMemoryDatabasePath);
...
//        config.AddImage(image_id);
//    }
//    colmap::ApplyRigConfig(colmap::ReadRigConfig(rig_config_path), database, &reconstruction);
//
//    std::unique_ptr<colmap::BundleAdjuster> bundle_adjuster = colmap::CreateDefaultBundleAdjuster(
